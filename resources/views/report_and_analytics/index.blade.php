    ...
    <div class="content">
                    ...
                    <div class="card-header ">
                        <div class="row">
                            <div class="col-sm-6 text-left">
                                <h2 class="card-title">New Products Added</h2>
                            </div>
                            {{--                                    <div class="col-sm-6">--}}
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card card-chart">
                    <div class="card-header">
                        <h5 class="card-category">Products Needs to Refile</h5>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12">
                <div class="card card-tasks">
                    <div class="card-header ">
                        <h6 class="title d-inline">Products Need to Buy(5)</h6>
                        <div class="dropdown">
                            ...
                            <table class="table">
                                ...
                                <span class="check"></span>
                                    ...
                                    <td>
                                        ...
                                        <p class="text-muted">The GDPR is a regulation that requires businesses
                                            to
                                ...
                                <span class="check"></span>
                                    ...
                                    <td>
                                        ...
                                        <p class="text-muted">Fifty percent of all respondents said they would
                                            be
            ...
            <div class="col-lg-6 col-md-12">
                <div class="card ">
                    <div class="card-header">
                        <h4 class="card-title"> Products Available In Inventory</h4>
                    </div>
                    <div class="card-body">
